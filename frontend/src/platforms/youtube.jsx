...
const Youtube = () => {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            if (response.ok) {
                setMessage('Download Completed, Kindly check our downloads folder.');
            } else {
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12 space-y-12">
                    ...
                    <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
                        ...
                        <button
                            ...
                            className="w-full sm:w-auto bg-sky-600 hover:bg-sky-700 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-lg transition-colors duration-200 shadow-md hover:shadow-lg"
                        >
